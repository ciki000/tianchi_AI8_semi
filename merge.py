...
datasets = ['./datasets/cifar_test', './datasets/test_PGD_preactresnet', './datasets/test_Auto_wideresnet', './datasets/test_DIFGSM_preactresnet', './datasets/test_wasserstein']
...
np.save('./datasets/eval_image.npy', images_merge)
np.save('./datasets/eval_label.npy', labels_merge)